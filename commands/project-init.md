...
subject, and keep that document as the source of truth. Do not duplicate it,
overwrite it, or create a parallel docs tree without the user's decision.

Treat this request only as project initialization and stop when initialization
is complete.
